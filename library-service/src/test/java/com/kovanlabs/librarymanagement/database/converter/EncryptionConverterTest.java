...
class EncryptionConverterTest {
    ...
    void testEncryptAndDecrypt_shouldWorkCorrectlyAndLog() {
        ...
        String encrypted = encryptionConverter.convertToDatabaseColumn(rawBase64Signature);
        ...
        String decrypted = encryptionConverter.convertToEntityAttribute(encrypted);
    ...
    void testNullAndEmptyHandling() {
        ...
        assertEquals("", encryptionConverter.convertToDatabaseColumn(""));
        assertNull(encryptionConverter.convertToEntityAttribute(null));
        assertEquals("", encryptionConverter.convertToEntityAttribute(""));
    }
}
