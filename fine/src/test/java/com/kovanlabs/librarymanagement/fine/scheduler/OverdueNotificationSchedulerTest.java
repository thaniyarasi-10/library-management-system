...
class OverdueNotificationSchedulerTest {
    ...
    void setUp() {
        ...
        scheduler = new OverdueNotificationScheduler(borrowRepository, sqsNotificationProducer, fineService);
    }
    ...
    void testSendOverdueNotifications_WithOverdueBorrows() {
        ...
        when(fineService.calculateTotalPendingFineForUser(1L)).thenReturn(BigDecimal.valueOf(30.0));
        ...
        verify(fineService, times(1)).calculateTotalPendingFineForUser(1L);
